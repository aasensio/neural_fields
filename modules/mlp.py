...
if (__name__ == '__main__'):
    ...
    if (which_case == '1D'):
        ...
        if (enconding_type == 'positional'):
            encoding = PositionalEncoding(sigma=30.0, n_freqs=n_freqs, input_size=1)
        else:
            encoding = GaussianEncoding(input_size=1, encoding_size=32, sigma=10.)
    ...
    if (which_case == '2D'):
        ...
        if (enconding_type == 'positional'):
            ...
            encoding = GaussianEncoding(input_size=2, encoding_size=32, sigma=1.0)
